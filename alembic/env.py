...
def get_url():
    user = get_settings().postgres.POSTGRES_USER
    password = get_settings().postgres.POSTGRES_PASSWORD
    host = get_settings().postgres.POSTGRES_HOST
    port = get_settings().postgres.POSTGRES_PORT
    db = get_settings().postgres.POSTGRES_DB
